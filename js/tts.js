...
const WORD_MAP = {
  // ============================================================
  // Урок 1: Изолированные буквы (Фонетика без алфавитных названий)
  // ============================================================

  // ИДЕАЛЬНЫЙ ЧИСТЫЙ [ʒ] (Ж): Французское слово "gige" в немецком TTS 
  // произносится как чистейший, мягкий изолированный звук [ж]. Никаких "galo".
  j: "gige",   

  // ЧИСТЫЙ [Х]: "ch" заставляет движок выдать чистый звук хрипа [х] без гласной "а" в начале.
  h: "ch",    
  ...
  qite: "kite",  
  vy: "vü",       
  es: "äs",       // Изменили на умляут для соответствия официальному [Э]

  // Lesson 3
  ro: "ro",
  jy: "jü",      // Внутри слова 'j' + 'ü' дает идеальное [жю]
  ane: "anä",    // Заменили на умляут, чтобы в конце было четкое [э]
